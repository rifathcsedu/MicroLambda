...
def GetDataForApp(app_name,type):
    if(app_name==1 and type==1):
        ...
        return CPUGraph("../CSV/Mental-Stress-App/FilteredCPU_MEM/", app_name)
        ...
        return MemoryGraph("../CSV/Mental-Stress-App/FilteredCPU_MEM/", app_name)
        ...
        return NetworkGraph("../CSV/Mental-Stress-App/Mental-Stress_network_data.csv", app_name)
